...
\begin{figure}
\includegraphics[scale=1.2]{images/IMU_sensor.pdf}
...
\begin{figure}
\includegraphics[scale=0.55]{images/acceleration_susanna.pdf}
\caption{}
\label{fig:acc}
\end{figure}

\begin{figure}
\includegraphics[scale=0.55]{images/angular_velocity_susanna.pdf}
\caption{}
\label{fig:gyr}
\end{figure}

\begin{figure}
\includegraphics[scale=0.55]{images/magnetic_field_susanna.pdf}
\caption{}
\label{fig:mag}
\end{figure}
