...
\begin{figure}[htp]
\includegraphics[scale=1.7]{CNN_arch.eps}
\caption{\gls{cnn} architecture}
\label{fig:CNN}
\end{figure}

\MC{here i'd put the processor chaaracteristics}
...
Because of the imposed fixed input shape of the \gls{cnn}, the dataset is composed by \MR{MILLE!!!} patterns with shape (27,9) that have been elaborated with a batch of \MR{MILLE!!!}.
   

After the 4 banchs of convolutional layers the filters are extracted
